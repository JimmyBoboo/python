...
from studenter import Student, Course
...
print(coursefunction.calculate_total_credits(nils_nilsen.courses))
...
print(coursefunction.calculate_total_credits(all_courses))
